$('document').ready(function() {
    ...
    if (true || /Mobi/.test(navigator.userAgent)) {
        ...
        var guppyDivEl = document.querySelector('#guppy1');
        guppyDivEl.insertAdjacentElement('afterend', fakeInputForMathExpression);
        guppyDivEl.insertAdjacentElement('afterend', startMathInputButton);
        
        var guppy1_offset = $(guppyDivEl).offset();
        ...
        $('#fakeInputForMathExpression').css({
            'width': '1px',
            'height': '1px',
            'opacity': 0,
            'padding': 0,
        ...
        $('#startMathInputButton').click(function(){
            ...
            var fake_input_element = $('#fakeInputForMathExpression')[0];
        ...
        $('#fakeInputForMathExpression').on('input change compositionstart compositionend compositionupdate keydown', $.debounce(100, function (e) {
            console.log(e);
